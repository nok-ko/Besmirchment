package me.nokko.bexment.common.block;

import me.nokko.bexment.common.block.entity.PhylacteryBlockEntity;
import me.nokko.bexment.common.entity.LichGemItem;
import me.nokko.bexment.common.transformation.LichAccessor;
import me.nokko.bexment.common.transformation.LichLogic;
import me.nokko.bexment.common.world.BSMWorldState;
        ...
        if (!client && phylactery instanceof PhylacteryBlockEntity) {
            ...
            if (LichGemItem.isSouled(stack)) {
                ...
                if (soulCount == 1){ //imagine supporting dual-case in code that would be very funny I think
                    player.sendMessage(new TranslatableText("message.bexment.phylactery_soul", ((PhylacteryBlockEntity) phylactery).souls), true);
                }else {
                    player.sendMessage(new TranslatableText("message.bexment.phylactery_souls", ((PhylacteryBlockEntity) phylactery).souls), true);
                }
            }
        }
