...
import me.nokko.bexment.common.transformation.LichTransformation;
import me.nokko.bexment.common.transformation.WerepyreTransformation;
...
public class BSMTransformations {
    ...
    public static boolean hasWerepyrePledge(PlayerEntity player){
        return BewitchmentAPI.isPledged(player, "pledge.bexment.beelzebub");
    }
