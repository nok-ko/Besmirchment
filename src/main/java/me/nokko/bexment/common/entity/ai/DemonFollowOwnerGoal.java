package me.nokko.bexment.common.entity.ai;
...
public class DemonFollowOwnerGoal<T extends DemonEntity & TameableDemon> extends Goal {
    ...
    public DemonFollowOwnerGoal(T tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
