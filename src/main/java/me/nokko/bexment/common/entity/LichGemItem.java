...
public class LichGemItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (isSouled(stack)){
            tooltip.add(new TranslatableText("tooltip.bexment.souled").fillStyle(Style.EMPTY.withColor(TextColor.fromRgb(0x8eed5e))));
        }else{
            tooltip.add(new TranslatableText("tooltip.bexment.empty").fillStyle(Style.EMPTY.withColor(TextColor.fromFormatting(Formatting.GRAY))));
        }
